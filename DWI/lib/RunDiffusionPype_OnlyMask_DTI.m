...
%% DTI-FIT
[AllDTIPaths] = FitDTI_MaskMrtrix(AllEddyPaths,AllSubs,DicomRootPath,data_info);
...
%% TBSS
% PrepareForTBSS
% [TBSS_Path] = PrepareForTBSS(EddyProcessed,data_info);
[TBSS_Path] = PrepareForTBSS_Glm(EddyProcessed,data_info);
